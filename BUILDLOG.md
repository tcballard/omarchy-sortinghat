...
- The current marketplace Automated Security Baseline initially identified the pinned QML scanner as downloaded executable content. Its exact SHA-256 is now verified before execution; the accepted residual capabilities are installer and user-service management only.
